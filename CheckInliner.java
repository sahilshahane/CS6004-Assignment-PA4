...
public class CheckInliner extends SceneTransformer{
    ...
    public void checkRecursionHelper(SootMethod method, HashMap<String, MethodWrapper> methodWrappers, LinkedList<MethodWrapper> callStack){
            ...
            if (unit instanceof InvokeStmt) {
                ...
                if (methodWrappers.containsKey(calledMethod.getSignature())) {
                    ...
                    if (callStack.contains(calledWrapper)) {
                        //if it is then there is a recursion and we can mark all methods in call stack as could not be inlined
    ...
    protected void internalTransform(String phaseName, Map<String, String> options) {
        ...
        //store all methods in hashmap of methoddWrappers , that have a faster searching time than soot's getMethodByName
                        ...
                        if (unit instanceof InvokeStmt) {
                            ...
                            if (invokeExpr instanceof StaticInvokeExpr) {
                                if (methodWrappers.containsKey(calledMethod.getSignature())
                                    ...
                                    System.out.println("Can inline: " + calledMethod.getSignature() + " in " + method.getSignature());
                                    ...
                                    System.out.println("Cannot inline: " + calledMethod.getSignature() + " in " + method.getSignature());
                                }
                            }
                        }
