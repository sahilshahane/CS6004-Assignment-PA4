...
sudo sh -c "java -cp sootOutput_baseline_metrics Test | grep -E '^(Static|Instance) Calls:' | tee \"perf_result/$TEST_NAME/baseline_invoke_metrics.txt\""
echo "=========================================================="
...
sudo sh -c "java -cp sootOutput_metrics Test | grep -E '^(Static|Instance) Calls:' | tee \"perf_result/$TEST_NAME/optimized_invoke_metrics.txt\""
echo "==========================================================="
...
sudo ./run_vanila.sh $TEST_CASE "perf_result/$TEST_NAME/baseline_perf_results.txt" "perf_result/$TEST_NAME/baseline_program_output.txt"
...
# mkdir -p $TIMESTAMP
# append to the file 
sudo sh -c "echo 'Optimized TEST CASE: $TEST_CASE' >> perf_result/$TEST_NAME/optimized_perf_results.txt"
sudo sh -c "perf stat -x, -d -d -r 5 -o perf_result/$TEST_NAME/optimized_perf_results.txt --append java -Xint -cp sootOutput Test > perf_result/$TEST_NAME/optimized_program_output.txt 2>&1"
